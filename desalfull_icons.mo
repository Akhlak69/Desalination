...
replaceable package Water = ThermoPower.Water.StandardWater constrainedby Modelica.Media.Interfaces.PartialPureSubstance "Fluid model";
  ...
  inner Modelica.Fluid.System system2 annotation(
    Placement(visible = true, transformation(origin = {-764, 190}, extent = {{-6, 12}, {6, -12}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant seawater_temp(k = 20) annotation(
    Placement(visible = true, transformation(origin = {172, 192}, extent = {{-52, -52}, {52, 52}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.ExpSine distillate_demand(amplitude = 300, damping = 0.01, freqHz = 0.1, offset = 90, startTime = 4000)  annotation(
    Placement(visible = true, transformation(origin = {163, 35}, extent = {{-43, -43}, {43, 43}}, rotation = 0)));
equation
  ...
  connect(h_sensor.port, sensW1.inlet) annotation(
    Line(points = {{42, 181}, {42, -230}}, color = {0, 127, 255}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 20));
  ...
  connect(seawater_temp.y, desalination_plant.seawater_temp) annotation(
    Line(points = {{230, 192}, {284, 192}, {284, 140}, {350, 140}}, color = {0, 0, 127}));
  connect(distillate_demand.y, desalination_plant.distillate_demand) annotation(
    Line(points = {{210, 36}, {286, 36}, {286, 60}, {350, 60}}, color = {0, 0, 127}));
protected
  annotation(
